"""Demo launcher for Method 3: Text inject + KV replace + length-preserving pad."""
import sys, os, argparse
sys.path.insert(0, os.path.dirname(os.path.dirname(os.path.abspath(__file__))))

from transformers import AutoTokenizer
from core.sensitive_config import SensitiveRegistry
from methods.method3_inject import Method3InjectBot
...
def run_demo(model_name=DEFAULT_MODEL, device="auto", example_name=None):
    ...
    for ex in examples_to_run:
        ...
        bot = Method3InjectBot(registry, model_name=model_name, device=device)
