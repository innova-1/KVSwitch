"""Demo launcher for Baseline 2: Secrets Always Hidden."""
import sys, os, argparse
sys.path.insert(0, os.path.dirname(os.path.dirname(os.path.abspath(__file__))))

from transformers import AutoTokenizer
from core.sensitive_config import SensitiveRegistry
from methods.baseline2_hidden import Baseline2Hidden
...
def run_demo(model_name=DEFAULT_MODEL, device="auto", example_name=None):
    ...
    for ex in examples_to_run:
        ...
        bot = Baseline2Hidden(registry, model_name=model_name, device=device)
